...
return [
    ...
    'title' => 'API de Adoção de Animais - PUCRS',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API para gestão de adoções de animais, organizações protetoras e usuários do sistema',
    ...
    'auth' => [
        ...
        'extra_info' => 'Para obter seu token de autenticação, faça login através do endpoint <code>/api/auth/login</code>. O token deve ser incluído no header Authorization como <code>Bearer {token}</code>.',
    ],
